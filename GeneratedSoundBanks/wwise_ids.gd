...
class EVENTS:
	...
	const PLAY_ROBOT = 1985594942
	const PLAY_AURA1 = 2204712644
	const PLAY_SHAKE = 3244659120

	const _dict = {
		"Play_robot": PLAY_ROBOT,
		"Play_aura1": PLAY_AURA1,
		"Play_shake": PLAY_SHAKE
	}
...
class BANKS:
	...
	const NEW_SOUNDBANK = 4072029455

	const _dict = {
		"Init": INIT,
		"New_SoundBank": NEW_SOUNDBANK
	}
...
class AUX_BUSSES:
	...
	const NEW_AUXILIARY_BUS = 373392551

	const _dict = {
		"New_Auxiliary_Bus": NEW_AUXILIARY_BUS
	}
